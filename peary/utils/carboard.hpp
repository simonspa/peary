...
const caribou::BIAS_REGULATOR_T BIAS_29("INJ_1", ADDR_DAC_U49, REG_DAC_CHANNEL_VOUTG);
const caribou::BIAS_REGULATOR_T BIAS_30("INJ_2", ADDR_DAC_U49, REG_DAC_CHANNEL_VOUTE);
const caribou::BIAS_REGULATOR_T BIAS_31("INJ_3", ADDR_DAC_U49, REG_DAC_CHANNEL_VOUTC);
const caribou::BIAS_REGULATOR_T BIAS_32("INJ_4", ADDR_DAC_U49, REG_DAC_CHANNEL_VOUTA);
