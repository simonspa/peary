...
const SLOW_ADC_CHANNEL_T VOL_IN_1("VOL_IN_1", 1, REG_ADC_CHANNEL_CH0);
const SLOW_ADC_CHANNEL_T VOL_IN_2("VOL_IN_2", 2, REG_ADC_CHANNEL_CH1);
const SLOW_ADC_CHANNEL_T VOL_IN_3("VOL_IN_3", 3, REG_ADC_CHANNEL_CH2);
const SLOW_ADC_CHANNEL_T VOL_IN_4("VOL_IN_4", 4, REG_ADC_CHANNEL_CH3);
const SLOW_ADC_CHANNEL_T VOL_IN_5("VOL_IN_5", 5, REG_ADC_CHANNEL_CH4);
const SLOW_ADC_CHANNEL_T VOL_IN_6("VOL_IN_6", 6, REG_ADC_CHANNEL_CH5);
const SLOW_ADC_CHANNEL_T VOL_IN_7("VOL_IN_7", 7, REG_ADC_CHANNEL_CH6);
const SLOW_ADC_CHANNEL_T VOL_IN_8("VOL_IN_8", 8, REG_ADC_CHANNEL_CH7);
